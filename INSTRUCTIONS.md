...
## Preparing your sample-app project

Copy the provided `config` and `catalog` directories including the files they contain into your `sample-app` project.

You can now follow the instructions below to deploy your project.

## Working on your sample-app project
